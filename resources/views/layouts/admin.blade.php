...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse flex-row-reverse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="{{ route('admin/projects') }}" id="navbarDropdown">
                        Projects
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin/roadmap') }}">Roadmap</a>
                </li>
    ...
    <main>
        <header>
            <h1>Este es el layout de  admin</h1>
        </header>
